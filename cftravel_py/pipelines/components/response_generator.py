    ...
    async def process(self, context: PipelineContext) -> PipelineContext:
        ...
        try:
            ...
            if intent == 'preference_complete':
                # Generate text-based preference summary - no confirmation dialog needed
                ...
                # For now, generate a confirmation message
                response = await self._generate_confirmation_response(context)
            elif intent == 'modification':
                # User wants to modify preferences - generate modification response
